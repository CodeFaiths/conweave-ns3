...
"""
NS-3 Experiment Manager (CPEM Test - Bandwidth Mismatch Edition)
...
def main():
    ...
    # Setup paths
    # Current script directory: ns-3.19/mix/CPEMTest/01_Bandwidth_Mismatch/
